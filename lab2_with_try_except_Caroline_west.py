...
name = input("Good Morning Adventurer! What is your name? ")
...
#storyline
print("You awake to the feel of cold, damp stone against your face. ")
time.sleep(1)
print("As your eyes adjust to the dim light, slightly aware of the musty scent of decay, you hear a dripping coming from the corner, and murmuring voices from the hallway.")
time.sleep(1)
print("Your mouth feels as if it's full of sand, and your head is pounding. ")
time.sleep(3)
...
#storyline
print("I would say nice to meet you " + name + " but these are trying times.")
print("What would you like to do first?")
print("*******************************************************")

print("\t 1. Go back to sleep. You really need to stop eating cookies at 2am")
print("\t 2. Drink the liquid dripping from the celing")
print("\t 3. Venture out into the hallway")
...
if choice == "1":
	#ends the game
	#storyline
	print("You close your eyes, sleep overtaking you once more.")
	print("When you are awake you are back in your own bed")
	print("Everything seems as it was...")
	print("But.. you have a newfound sense of eunnui that is to trail you the rest of your mediocrel life")
	print("The doors of Valhalla are closed to you forever")
	quit()

elif choice == "2": 
	#storyline
	print("You hurry over to the corner to the dripping and open your mouth wide")
	print("savoring the relief it brings your parched throat")
	print("You drink until your tongue no longer feels like sandpaper and your headache ceases")

	water_counter=water_counter+5

	print("\t 1. Now that your thirst is quenched, you lay down and sleep")
	print("\t 2. Venture out into the hallway")
	...
	if choice2 == "1":
		#ends the game
		#storyline
		print("When you awake, you are back in your own bed. Everything seems normal")
		print("But... you have a newfound sense of eunni that is to trail you the rest of your miserable existence")
		print("The doors of Valhalla are closed to you forever")
		quit()
...
#storyline
print("You creep silently into the hallway")
print("To the left of you is complete darkness")
print("A darkness so complete it's not merely the absence of light, ")
print("but it appears to absorb and devour the essence of light itself")
print("A beckoning power is emanating from the darkness that your soul instantly craves")
print("To the right, you see faint, flickering light along with voices")
print("You hear laughing merriment, but a few growls that sound both human and animal simultaneously")
print("")

print("\t 1. Go to the left into the darkness")
print("\t 2. Go to the right to the voices")
...
if choice3=="1":
	...
	#storyline
	print("You walk slowly into the darkness, ")
	print("but then your pace picks up as if your feet have a mind of their own.")
	print("Before you know it you are running, sprinting")
	print("as if your life depends on getting into the void")
	time.sleep(2)
	print("You can't get there fast enough, you have to get to the heart of the tunnel.")
	print("Your mind is consumed with this sole objective")
	print("You've never wanted anything more in your life")
	print("Getting there is the air your lungs need to breath, ")
	print("fighting the temptation tears away your essence from your terrestrial body")
	time.sleep(2)
	print("")
	print("You finally reach the source of the darkness, your feet skidding to a stop")
	print("You swivel your head around, but are unable to see through the impenetrable obscurity")
	print("There's a fleeting sense you should be scared, but that word, ")
	print("and even the concept itself of fear evaporates from your vocabulary")
	print("")
	print("You are not alone. Something is here. ")
	print("The word 'Master' appears in your brain as you consider the entity that surround you")
	print("You cock your head as you consider this new information")
	print("You feel as if you are finally home")
	print("For once in your miserable existence, you are calm, and you know your purpose")
	print("")
	print("\t 1. Fully submit to all that is right with the universe")
	print("\t 2. Fight with the shred of willpower left to overcome the creature")
	...
	if choice4=="1":
		...
		#storyline
		print("Pain, sorrow, hunger, all of these are foreign to you now")
		print("You feel raw power in your veins, and it's intoxicating")
		print("A map appears in your head, leading the way to the chamber ")
		print(" with the voices you had considered earlier")
		print("It told you everyone in there is a threat.")
		print("Overwhelming desire to fulfill that objective consumes all that you are")
		print("There is no future, no past, just action")
		print("Fighting the urge is futile, and your feet are already moving")
		print("Each step warps the space around you")
		print("Each stride traversing 20 feet,")
		print("and you are within the dimly lit chamber in seconds")
		print("")
